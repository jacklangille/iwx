...
CREATE INDEX IF NOT EXISTS oracle_observations_contract_observed_idx
...
CREATE TABLE IF NOT EXISTS contract_resolutions (
  ...
  resolved_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT NOW()
);

CREATE INDEX IF NOT EXISTS contract_resolutions_contract_resolved_idx
